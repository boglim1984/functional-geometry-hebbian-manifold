...
### 🔍 Phase I Visual Artifacts (Manifold Discovery)

The following static images provide visual grounding for the Phase I experiments. Each image corresponds directly to a single Colab notebook listed above. These previews are **illustrative only**; canonical data and measurements are derived from the notebooks and PLY artifacts.

- **Trained network manifold**  
  Generated by `01_neuro_cartography.ipynb`  
  ![Trained Layer 4 Manifold](artifacts/figures/phase1_trained_layer4.jpg)

- **Untrained baseline manifold**  
  Generated by `02_untrained_baseline_manifold.ipynb`  
  ![Untrained Layer 4 Manifold](artifacts/figures/phase1_untrained_layer4.jpg)

- **Pixel-shuffle control manifold**  
  Generated by `03_pixel_shuffle_control.ipynb`  
  ![Pixel-Shuffled Layer 4 Manifold](artifacts/figures/phase2_pixelshuffle_layer4.jpg)

These images are intended to help readers visually orient to the experiments and should not be interpreted as quantitative evidence. All validation and measurements are reported in the linked notebooks and empirical results tables.
